import{A as e,C as t,D as n,E as r,O as i,S as a,T as o,_ as s,a as c,b as l,c as u,d,f,h as p,i as m,k as h,l as g,m as _,n as v,o as y,p as b,r as x,s as S,t as C,u as w,v as T,w as E,x as D,y as O}from"./quantum-morph-runtime.js";import{t as k}from"./quantum-morph-gsap.js";var A=e(x(),1),j=(e,t,n,r,i)=>(e-t)*(i-r)/(n-t)+r,M=class e{constructor(e,t){this.scene=e,this.renderer=e.renderer,this.gl=this.gl,this.camera=e.camera,this.textures=t,this.lastTime=0,this.everRendered=!1,this.mousePos=new n(0,0),this.cursorPos=new n(0,0),this.colorScheme=e.theme===`dark`?0:1,this.particleScale=this.scene.renderer.domElement.width/this.scene.pixelRatio/2e3*this.scene.particlesScale}static async create(t,n){let r=new e(t,n);return r.createPoints(),await r.createPointsFromImage(),r.init(),r}async getImageData(e){return new Promise((t)=>{let r=new Image;r.crossOrigin='anonymous';r.src=e;r.onload=()=>{try{let e=document.createElement(`canvas`);e.width=500,e.height=500;let n=e.getContext(`2d`);n?n.drawImage(r,0,0,500,500):void 0;t(n?n.getImageData(0,0,500,500):new ImageData(500,500))}catch(c){t(new ImageData(500,500))}},r.onerror=()=>{t(new ImageData(500,500))}})}createPoints(){let e=new A.default({shape:[500,500],minDistance:j(this.scene.density,0,300,10,2),maxDistance:j(this.scene.density,0,300,11,3),tries:20}).fill();this.pointsBaseData=e,this.pointsData=[];for(let t=0;t<e.length;t++)this.pointsData.push(e[t][0]-250,e[t][1]-250);this.count=this.pointsData.length/2}async createPointsFromImage(){let e=[];for(let t=0;t<this.textures.length;t++){try{let n=await this.getImageData(this.textures[t]);e.push(n)}catch(r){e.push(new ImageData(500,500))}}this.nearestPointsData=[];let t=[];for(let n=0;n<this.textures.length;n++)t.push(this.createPointsDistanceDataWorker(e[n],this.pointsBaseData,n));try{let n=await Promise.all(t);n.sort((e,t)=>e.index-t.index),n.forEach(e=>{this.nearestPointsData.push(e.nearestPoints)})}catch(i){this.nearestPointsData=[this.pointsData]}}createPointsDistanceDataWorker(e,t,n){return new Promise((r)=>{let a=new Blob([`
                self.onmessage = function(e) {
                    ...
                    for (let i = 0; i < pointsBase.length; i++) {
                        ...
                        if (!nearestPoint) {
                            nearestPoint = [pointsBase[i][0] + 250, pointsBase[i][1] + 250];
                        }
                        nearestPoints.push(
                            nearestPoint[0] - 250,
                            nearestPoint[1] - 250
